...
// No cartão
    ...
    // 3 parcelas = acréscimo de 10%
    /**
     * Estrutura de Repetição
     */
    // while -> enquanto

const precoProduto = parseFloat(prompt('Qual o preço do produto?')) // recebendo o preço do produto e transformando o valor para decimal.
const mensagem = `
